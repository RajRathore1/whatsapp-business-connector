...
class ResConfigSettings(models.TransientModel):
    ...
    whatsapp_access_token = fields.Char(
        ...
        config_parameter='digimonk_whatsapp.access_token',
    )
    whatsapp_phone_number_id = fields.Char(
        string='Phone Number ID',
        config_parameter='digimonk_whatsapp.phone_number_id',
    )
    whatsapp_waba_id = fields.Char(
        string='WhatsApp Business Account ID',
        config_parameter='digimonk_whatsapp.waba_id',
    )
    whatsapp_app_id = fields.Char(
        string='App ID',
        config_parameter='digimonk_whatsapp.app_id',
    )
    whatsapp_app_secret = fields.Char(
        string='App Secret',
        config_parameter='digimonk_whatsapp.app_secret',
    )
    whatsapp_webhook_verify_token = fields.Char(
        string='Webhook Verify Token',
        config_parameter='digimonk_whatsapp.webhook_verify_token',
    )
    ...
    def get_values(self):
        ...
        tmpl_id = ICP.get_param('digimonk_whatsapp.default_template_id', '')
        try:
    ...
    def set_values(self):
        ...
        ICP = self.env['ir.config_parameter'].sudo()
        ICP.set_param(
            'digimonk_whatsapp.default_template_id',
